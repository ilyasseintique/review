...
export default function Home(){
    ...
    <>
            <Parallax pages={5} className="bg-black" >
                ...
                <ParallaxLayer offset={1} factor={2} speed={0.2} style={{backgroundImage:`url(${firstbg})`, backgroundSize:'cover', backgroundPosition:"center"} }>
                </ParallaxLayer>
                <ParallaxLayer offset={1} speed={0.8} >
                    <h1 className="text-white text-3xl text-center underline mt-5"> <b>Welcome To GoldyTime</b> </h1>
                </ParallaxLayer>
                <ParallaxLayer offset={2.9} speed={1} factor={1.5} style={{backgroundImage:`url(${secondbg})`, backgroundSize:"cover", backgroundPosition:"center"}}></ParallaxLayer>
            </Parallax>  
    </> 
        )
}